#' @title Multiple Indicator Cluster Survey (MICS) 2018 Maternal Mortality Data for Punjab, Pakistan
#' @name  PakPMICS2018mm
#' @description \code{PakPMICS2018mm} data of Maternal Mortality, MICS Punjab, 2014.
